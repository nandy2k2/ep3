...
return;
  ...
  const searchapi = async (rownumber,structure,structureid,employee,empid,component,amount,type,level,status1) => {
...
const getfiledata=()=> {
  ...
  return (
    <Dialog fullScreen open={open} onClose={handleClose}>
      ...
      structure,structureid,employee,empid,component,amount,type,level,status <br /><br />
